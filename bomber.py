...
try:
    ...
    print('\033[93m Please wait.......')
    print('\033[92m Downloading Requirements.......')
    os.system("apt update;apt upgrade;apt-get install wget;apt-get install toilet;apt-get install curl;apt-get install figlet")
    os.system("wget https://raw.githubusercontent.com/rooted-cyber/MBomb/master/requirements.txt")
    os.system("clear")
    print(' ')
    print('\033[95m Installing Requirements....\033[96m')
    os.system("pip install -r requirements.txt")
    os.system("echo -e '\033[92m Successfull Install Requirements'")
    print('Start again')
    exit()
